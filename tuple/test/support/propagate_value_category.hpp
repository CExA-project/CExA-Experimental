...
KOKKOS_INLINE_FUNCTION constexpr ValueCategory operator&(ValueCategory LHS, ValueCategory RHS) {
...
KOKKOS_INLINE_FUNCTION constexpr bool isValidValueCategory(ValueCategory VC) {
  return (VC & (VC_LVal | VC_RVal)) != (VC_LVal | VC_RVal);
}

KOKKOS_INLINE_FUNCTION constexpr bool hasValueCategory(ValueCategory Arg, ValueCategory Key) {
...
template <class Tp>
KOKKOS_INLINE_FUNCTION constexpr ValueCategory getReferenceQuals() {
...
template <class Tp>
KOKKOS_INLINE_FUNCTION constexpr ValueCategory getCVQuals() {
...
template <class Tp>
KOKKOS_INLINE_FUNCTION constexpr ValueCategory getValueCategory() {
...
public:
  ...
  KOKKOS_INLINE_FUNCTION static Apply<UnCVRef<Tp>> cast(Tp &&t) {
  ...
  // FIXME: added a default argument because nvcc complained about template redefinition
  template <
      class Tp, bool Dummy = true, class Ignored = void,
...
template <ValueCategory VC, class Tp>
KOKKOS_INLINE_FUNCTION typename ApplyValueCategory<VC>::template Apply<Tp> ValueCategoryCast(Tp &&t) {
