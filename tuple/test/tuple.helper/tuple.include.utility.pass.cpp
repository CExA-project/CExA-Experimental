...
void test()
{
    ...
    static_assert((std::is_same<typename cexa::tuple_element<idx, T>::type, U>::value), "");
    static_assert((std::is_same<typename cexa::tuple_element<idx, const T>::type, const U>::value), "");
    static_assert((std::is_same<typename cexa::tuple_element<idx, volatile T>::type, volatile U>::value), "");
    static_assert((std::is_same<typename cexa::tuple_element<idx, const volatile T>::type, const volatile U>::value), "");
}
