...
static_assert(cexa::tuple_size<SizedRange>::value == 2);
static_assert(cexa::tuple_size<UnsizedRange>::value == 2);
static_assert(cexa::tuple_size<ThreeElementRange>::value == 2);

template <int I, class Range, class Expected>
constexpr bool test_tuple_element() {
  static_assert(std::same_as<typename cexa::tuple_element<I, Range>::type, Expected>);
  static_assert(std::same_as<typename cexa::tuple_element<I, const Range>::type, Expected>);
