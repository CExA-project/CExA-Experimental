...
TEST(Assign_Emplace, IndexDirect) {
  test_util::test_helper<Assign_Emplace_IndexDirect>();
}
...
TEST(Assign_Emplace, IndexDirectDuplicate) {
  test_util::test_helper<Assign_Emplace_IndexDirectDuplicate>();
}
...
TEST(Assign_Emplace, IndexConversion) {
  test_util::test_helper<Assign_Emplace_IndexConversion>();
}
...
TEST(Assign_Emplace, IndexConversionDuplicate) {
  test_util::test_helper<Assign_Emplace_IndexConversionDuplicate>();
}
...
TEST(Assign_Emplace, IndexInitializerList) {
  test_util::test_helper<Assign_Emplace_IndexInitializerList>();
}
...
TEST(Assign_Emplace, TypeDirect) {
  test_util::test_helper<Assign_Emplace_TypeDirect>();
}
...
TEST(Assign_Emplace, TypeConversion) {
  test_util::test_helper<Assign_Emplace_TypeConversion>();
}
...
TEST(Assign_Emplace, TypeInitializerList) {
  test_util::test_helper<Assign_Emplace_TypeInitializerList>();
}
