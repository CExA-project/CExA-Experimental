...
#ifndef __INTEL_COMPILER  // The intrinsics are already overriden when this
                          // macro is defined
...
[[nodiscard]] KOKKOS_IMPL_HOST_FORCEINLINE_FUNCTION
    ...
    exp(Experimental::basic_simd<
        double, Experimental::simd_abi::avx2_fixed_size<4>> const& x) {
...
[[nodiscard]] KOKKOS_IMPL_HOST_FORCEINLINE_FUNCTION
    ...
    exp(Experimental::basic_simd<
        float, Experimental::simd_abi::avx2_fixed_size<8>> const& x) {
...
[[nodiscard]] KOKKOS_IMPL_HOST_FORCEINLINE_FUNCTION
    ...
    exp(Experimental::basic_simd<
        float, Experimental::simd_abi::avx2_fixed_size<4>> const& x) {
  return Experimental::basic_simd<float,
                                  Experimental::simd_abi::avx2_fixed_size<4>>(
...
exp(Experimental::basic_simd<
    double, Experimental::simd_abi::avx512_fixed_size<8>> const& x) {
  return Experimental::basic_simd<double,
...
exp(Experimental::basic_simd<
    float, Experimental::simd_abi::avx512_fixed_size<16>> const& x) {
...
exp(Experimental::basic_simd<
    float, Experimental::simd_abi::avx512_fixed_size<8>> const& x) {
  return Experimental::basic_simd<float,
                                  Experimental::simd_abi::avx512_fixed_size<8>>(
